...
const grpc_bchrpc_browser_2 = require("grpc-bchrpc-browser");
const client = new grpc_bchrpc_browser_1.GrpcClient({
...
class Live {
    subscribeMempool() {
        return __awaiter(this, void 0, void 0, function* () {
            var filter = new grpc_bchrpc_browser_2.TransactionFilter();
            filter.setAllTransactions(true);
            var subscribreTransactionRequest = new grpc_bchrpc_browser_2.SubscribeTransactionsRequest();
            subscribreTransactionRequest.setIncludeMempool(true);
            subscribreTransactionRequest.setSubscribe(filter);
            this.stream = yield client.subscribeTransactions({
...
},{"buffer":3,"grpc-bchrpc-browser":5}],2:[function(require,module,exports){
'use strict'
...
},{"./pb/BchrpcServiceClientPb":8,"./pb/bchrpc_pb":9,"./src/client":10}],6:[function(require,module,exports){
...
},{"./bchrpc_pb":9,"grpc-web":7}],9:[function(require,module,exports){
// source: bchrpc.proto
/**
 * @fileoverview
 * @enhanceable
...
},{"google-protobuf":6}],10:[function(require,module,exports){
"use strict";
var __importStar = (this && this.__importStar) || function (mod) {
    if (mod && mod.__esModule) return mod;
    var result = {};
...
class GrpcClient {
    ...
    */
    ...
    getUnspentOutput({ hash, vout, reversedHashOrder, includeMempool }, metadata) {
...
},{"../pb/BchrpcServiceClientPb":8,"../pb/bchrpc_pb":9,"buffer":3}]},{},[1])(1)
});
