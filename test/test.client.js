...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "buffer", "chai", "xhr2", "../index"], factory);
    }
    ...
    const client = new index_1.GrpcClient({
    ...
    describe("grpc-bchrpc-web", () => {
        ...
        it("getBlockInfo for index 0", () => __awaiter(void 0, void 0, void 0, function* () {
            const info = yield client.getBlockInfo({ index: 0 }, null);
        ...
        it("submitTransaction should broadcast", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                yield client.submitTransaction({ txnHex }, null);
            }
            catch (err) {
